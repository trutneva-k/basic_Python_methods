...
| pandas_basic_methods.ipynb|  'melt()', 'pivot()', 'pivot_table()', 'describe()', 'drop_duplicates()', 'reset_index()', 'set_index()', 'fillna()', 'dropna()', 'groupby()', 'merge()', 'concat()', 'apply()', 'isna()', 'notna()', 'sort_values()', 'sort_index()'|
[methods_for_strings.py](https://github.com/trutneva-k/basic_methods/blob/main/pandas_basic_methods.ipynb)
